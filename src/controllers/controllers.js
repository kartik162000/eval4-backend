...
const saveContentTypes = async (req, res) => {
  try {
    ...
    const newContentType = await services.saveContentTypes({
      contentType,
      userId,
      contentStructure,
    });
...
const updateContentTypes = async (req, res) => {
  try {
    ...
    const updatedContentType = await services.updateContentTypes({
      contentType,
      contentStructure,
    });
...
const getContentStructure = async (req, res) => {
  try {
    ...
    const contentStructure = await services.getContentStructure({
      userId,
      contentType,
    });
...
const deleteContentTypes = async (req, res) => {
  try {
    ...
    const deletedContentType = await services.deleteContentTypes(id, {
      contentType,
      contentStructure,
    });
...
const saveCollections = async (req, res) => {
  try {
    ...
    const newCollection = await services.saveCollections({
      Collection_Name,
      Collection_Value,
      contentType,
      userId,
